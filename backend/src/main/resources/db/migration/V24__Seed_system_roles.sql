...
INSERT INTO roles (name, description, role_type, is_modifiable, created_at, updated_at) VALUES
('ADMIN', 'Platform Administrator - Full system access', 'SYSTEM', false, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
